...
void init_offsets() {
    ...
    */
    ...
    else if (strcmp(u.version, "Darwin Kernel Version 16.3.0: Mon Nov  7 21:58:43 PST 2016; root:xnu-3789.30.92~36/RELEASE_ARM64_T7000") == 0) {
        allproc_offset = 0x5b8468;
        rootvnode_offset = 0x5be0b8;
    }
    ...
    else if (strcmp(u.version, "Darwin Kernel Version 16.3.0: Tue Nov  1 22:23:11 PDT 2016; root:xnu-3789.30.86~54/RELEASE_ARM64_S5L8960X") == 0) {
        allproc_offset = 0x5ac218;
        rootvnode_offset = 0x5b20b8;
    }
    else if (strcmp(u.version, "Darwin Kernel Version 16.0.0: Wed Aug 10 22:33:09 PDT 2016; root:xnu-3789.2.2~4/RELEASE_ARM64_S5L8960X") == 0) {
        allproc_offset = 0x5a4128;
        rootvnode_offset = 0x5aa0b8;
    }
    else if (strcmp(u.version, "Darwin Kernel Version 16.3.0: Tue Nov  1 22:23:10 PDT 2016; root:xnu-3789.30.86~54/RELEASE_ARM64_T7000") == 0) {
        allproc_offset = 0x5b8268;
        rootvnode_offset = 0x5be0b8;
    }
    else {
